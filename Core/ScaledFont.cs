...
/// <summary>
/// A game font rasterized at a requested pixel size, rebuilt only when that size changes.
///
/// The alternative, ImGui's SetWindowFontScale, stretches the glyph bitmaps that were baked at
/// the default size, so anything above 1.0 goes soft. Rasterizing at the target size keeps the
